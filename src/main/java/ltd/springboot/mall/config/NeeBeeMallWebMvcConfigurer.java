package ltd.springboot.mall.config;

import ltd.springboot.mall.common.Constants;
import ltd.springboot.mall.interceptor.AdminLoginInterceptor;
import ltd.springboot.mall.interceptor.NewBeeMallCartNumberInterceptor;
import ltd.springboot.mall.interceptor.NewBeeMallLoginInterceptor;
...
public class NeeBeeMallWebMvcConfigurer implements WebMvcConfigurer {
    ...
    @Autowired   //AdminLoginInterceptor 后台信息管理的拦截器
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(adminLoginInterceptor)
                ...
                .excludePathPatterns("/admin/login")//放行登录
