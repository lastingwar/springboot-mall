...
import ltd.springboot.mall.common.*;
import ltd.springboot.mall.controller.vo.*;
import ltd.springboot.mall.dao.NewBeeMallGoodsMapper;
import ltd.springboot.mall.dao.NewBeeMallOrderItemMapper;
import ltd.springboot.mall.dao.NewBeeMallOrderMapper;
...
import ltd.springboot.mall.entity.NewBeeMallOrderItem;
import ltd.springboot.mall.entity.StockNumDTO;
import ltd.springboot.mall.service.NewBeeMallOrderService;
import ltd.springboot.mall.util.BeanUtil;
import ltd.springboot.mall.util.NumberUtil;
...
public class NewBeeMallOrderServiceImpl implements NewBeeMallOrderService {
    ...
    @Override
    @Transactional//检测订单状态是否完成，标记为事物
